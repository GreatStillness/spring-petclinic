...
INSERT INTO vets (first_name, last_name) SELECT 'Eugene', 'Shpak' WHERE NOT EXISTS (SELECT * FROM vets WHERE id=7);
INSERT INTO vets (first_name, last_name) SELECT 'Olga', 'Shpak' WHERE NOT EXISTS (SELECT * FROM vets WHERE id=8);
...
INSERT INTO specialties (name) SELECT 'IT Specialist' WHERE NOT EXISTS (SELECT * FROM specialties WHERE name='IT Specialist');
...
INSERT INTO vet_specialties VALUES (7, 4) ON CONFLICT (vet_id, specialty_id) DO NOTHING;
